...
| SPEC-08 | Offline observability | 2 | Done | main | (see log) | green | telemetry.ts: window error boundary + bounded ring + User Timing marks; engine-core untouched; +5 tests; browser walk PASSES (clean server) |
