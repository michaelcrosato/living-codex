...
| SPEC-09 | Accessibility pass | 2 | Done | main | (see log) | green | DialogueView: role=dialog/aria-live/focusable buttons/focus-trap+restore; reduced-motion; dyslexia-font toggle; 3 e2e a11y specs PASS (browser) |
...
- [◐] **Wave 2 partial (the "durable saves + observability" goal)** — SPEC-10 + SPEC-08 done & browser-verified; 164 tests. SPEC-09 a11y + SPEC-13 content remain (deferred to a UI/curation-focused session).
